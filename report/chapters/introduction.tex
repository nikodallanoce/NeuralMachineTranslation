...
\begin{figure}[H]%
    ...
    \subfloat[Scaled Dot-Product Attention]{{\includegraphics[width=0.50\linewidth]{images/self_attention.png}}}%
...
\begin{figure}[H]%
    \centering
    \subfloat[BERT single layer]{{\includegraphics[width=0.50\linewidth]{images/bert_layer.png}}}%
    \subfloat[BERT stacked layers]{{\includegraphics[width=0.50\linewidth]{images/bert_layers.png}}}%
